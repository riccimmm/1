...
if ($rights < 1) {
    header('Location: http://goa-futs.ru/?err');
    exit;
}
...
if ($rights = 7 )echo '<li><a href="spy.php?act=get">Шпион MAIL</a></li>'; 
echo '<li><a href="../rassylka.php">Рассылка сообщение</a></li>'; 
if ($rights >= 7) echo '<li><a href="../award/panel.php">Награды</a></li>';
    echo '<li><a href="index.php?act=mod_blogs">Блоги</a></li>';
    echo '</ul></p>';
    }
    echo '</div>';
