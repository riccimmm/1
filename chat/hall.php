...
echo '<div class="phdr"><b>В прихожей (<a href="who.php">' . wch(0, 1) . '</a>)</b></div>';
echo '<p><a href="who.php">Кто в чате? (' . wch(0, 2) . ')</a><br/>';
echo '<a href="index.php?act=moders&amp;id=' . $id . '">Модераторы</a><br/>';
echo "<a href='../str/my_set.php?act=chat'>Настройки чата</a></p>";
