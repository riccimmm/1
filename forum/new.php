...
echo '<a class="at" href="index.php">Вернуться в форум</a>';
    ...
    switch ($do
        ...
        case 'all' :
            ...
            if ($count > 0) {
                ...
                while ($res = mysql_fetch_array($req)) {
                    ...
                    echo '<br /><div class="d"><a href="index.php?id=' . $razd['id'] . '">' . $frm['text'] . '&nbsp;/&nbsp;' . $razd['text'] . '</a><br />';
                    echo $res['from'];
                    if ($colmes1 > 1) {
                        echo '&nbsp;/&nbsp;' . $nick['from'];
                    }
        ...
        default :
            ...
            if ($total > 0) {
                ...
                echo '<div class="d"><a href="index.php?act=new&amp;do=reset">Сброс!</a><br/>';
            }
            else {
                echo '<div class="c">Непрочитанных тем нет.</div><div class="c">';
            }
            echo '<a href="index.php?act=new&amp;do=select">Показать за период</a></div>';
            break;
    }
}
else {
