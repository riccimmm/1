...
echo '<div class="gmenu"><b>1/2 финала</b></div>';

// Выводим туры
$g = mysql_query("select * from `liga_game_2` where gr='1/2' AND tur='1' order by id asc;");
$gd = mysql_query("select * from `liga_game_2` where gr='1/2' AND tur='1' order by id asc limit 1;");
...
if ($realtime > $arr[time])
{
echo ' <a href="12.php?act=play&amp;id='.$arr[id].'"><font color="green"><b>?:?</b></font></a>';
}
...
// Выводим туры
$g = mysql_query("select * from `liga_game_2` where gr='1/2' AND tur='2' order by id asc;");
$gd = mysql_query("select * from `liga_game_2` where gr='1/2' AND tur='2' order by id asc limit 1;");
...
$req = mysql_query("SELECT COUNT(*) FROM `liga_game_2` where `gr`='1/2' AND `rez1`!='' ;");
$total = mysql_result($req, 0);

if($total == 4){
$req = mysql_query("SELECT COUNT(*) FROM `liga_game_2` where `gr`='1/1' ;");
$total = mysql_result($req, 0);
if($total == 0){

$req = mysql_query("SELECT * FROM `liga_game_2` where `gr`='1/2' AND `tur`='1' order by id asc;");
            $i = 1;
            ...
            $req = mysql_query("SELECT * FROM `liga_game_2` where `gr`='1/2' AND `tur`='2' order by id asc;");
            $i = 1;
...
if($rights == 9){
echo 'Матчи 1/1 сгенерированы.<br/>';
            ...
            $turtime1 = $realtime;
            mysql_query("insert into `liga_game_2` set `gr`='1/1',`tur`='1',`time`='" . $turtime1 .
