...
echo '<div class="gmenu"><b>1/4 финала</b></div>';

// Выводим туры
$g = mysql_query("select * from `liga_game-2` where gr='1/4' AND tur='1' order by id asc;");

$gd = mysql_query("select * from `liga_game-2` where gr='1/4' AND tur='1' order by id asc limit 1;");
...
if ($realtime > $arr[time])
{
echo ' <a href="14.php?act=play&amp;id='.$arr[id].'"><font color="green"><b>?:?</b></font></a>';
}
...
// Выводим туры
$g = mysql_query("select * from `liga_game_2` where gr='1/4' AND tur='2' order by id asc;");
$gd = mysql_query("select * from `liga_game_2` where gr='1/4' AND tur='2' order by id asc limit 1;");
$ard = mysql_fetch_array($gd);
echo '<div class="c">';
...
$req = mysql_query("SELECT COUNT(*) FROM `liga_game_2` where `gr`='1/4' AND `rez1`!='' ;");
$total = mysql_result($req, 0);

if($total == 8){
$req = mysql_query("SELECT COUNT(*) FROM `liga_game_2` where `gr`='1/2' ;");
$total = mysql_result($req, 0);
if($total == 0){

 $req = mysql_query("SELECT * FROM `liga_game_2` where `gr`='1/4' AND `tur`='1' order by id asc;");
            $i = 1;
            ...
            $req = mysql_query("SELECT * FROM `liga_game_2` where `gr`='1/4' AND `tur`='2' order by id asc;");
            $i = 1;
...
if($rights == 9){
echo 'Матчи 1/2 сгенерированы.<br/>';
            echo '' . $name4[1] . '-' . $name4[2] . '<br/>';
            echo '' . $name4[3] . '-' . $name4[4] . '<br/>';
}
            ...
            mysql_query("insert into `liga_game_2` set `gr`='1/2',`tur`='1',`time`='" . $turtime1 .
                "',`id_team1`='" . $id1_1 . "',`id_team2`='" . $id2_1 . "'  ,`union_team1`='" .
                $union1_1 . "',`union_team2`='" . $union2_1 . "'  ,`name_team1`='" . $name1_1 .
                "',`name_team2`='" . $name2_1 . "',`level_team1`='" . $level1_1 .
                "',`level_team2`='" . $level2_1 . "';");
            mysql_query("insert into `liga_game_2` set `gr`='1/2',`tur`='1',`time`='" . $turtime1 .
                "',`id_team1`='" . $id3_1 . "',`id_team2`='" . $id4_1 . "'  ,`union_team1`='" .
                $union3_1 . "',`union_team2`='" . $union4_1 . "'  ,`name_team1`='" . $name3_1 .
                "',`name_team2`='" . $name4_1 . "',`level_team1`='" . $level3_1 .
                "',`level_team2`='" . $level4_1 . "';");


            mysql_query("insert into `liga_game_2` set `gr`='1/2',`tur`='2',`time`='" . $turtime2 .
                "',`id_team1`='" . $id2_1 . "',`id_team2`='" . $id1_1 . "'   ,`union_team1`='" .
                $union2_1 . "',`union_team2`='" . $union1_1 . "'  ,`name_team1`='" . $name2_1 .
                "',`name_team2`='" . $name1_1 . "',`level_team1`='" . $level2_1 .
                "',`level_team2`='" . $level1_1 . "';");
            mysql_query("insert into `liga_game_2` set `gr`='1/2',`tur`='2',`time`='" . $turtime2 .
                "',`id_team1`='" . $id4_1 . "',`id_team2`='" . $id3_1 . "'   ,`union_team1`='" .
                $union4_1 . "',`union_team2`='" . $union3_1 . "'  ,`name_team1`='" . $name4_1 .
                "',`name_team2`='" . $name3_1 . "',`level_team1`='" . $level4_1 .
